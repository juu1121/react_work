...
function PostDetail(props) {
    ...
    const handleCommentFormSubmit = (e)=>{
        ...
        .then(res=>{
            ...
            refreshComments();
            //댓글 입력창 초기화
            e.target.content.value=""; //textarea의 value에 빈 문자열 넣어주기
        })
...
function CommentLi({postNum, comment, onRefresh}){
    ...
    // 프로필 이미지 처리 //profileImage 여기에 들어가는건 문자열 //프로필이미지가있냐 : 있으면 이미지로딩, 없으면 기본이미지  => 백티과삼항연산자사용
